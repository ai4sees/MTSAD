...
class SlidingWindowDataset(Dataset):
    ...
    def __getitem__(self, index):
        x = self.data[index : index + self.window] #494 594
        y = self.data[index + self.window : index + self.window + self.horizon] #594 595
        return x, y
...
def adjust_anomaly_scores(scores, dataset, is_train, lookback, flag = True):
    """
    ...
    if flag:
        print(flag)
        s = [0, 2128, 2892]#, 6567, 8641, 10092, 12336, 14934, 17445, 20787, 22996, 25204, 27241, 29317, 31349, 32914, 34501, 38809, 42778, 45658, 49340, 50266, 51411, 52556, 54828]

...
class Predictor:
    ...
    def predict_anomalies(self, train, test, true_anomalies, msl_flag, load_scores=False, save_output=True,
                          scale_scores=False):
        """ Predicts anomalies
        ...
        if load_scores:
            ...
            train_anomaly_scores = adjust_anomaly_scores(train_anomaly_scores, self.dataset, True, self.window_size, flag = msl_flag)
            test_anomaly_scores = adjust_anomaly_scores(test_anomaly_scores, self.dataset, False, self.window_size, flag = msl_flag)
